...
public class Signup extends JFrame implements ActionListener {
 ...
 JButton b;
 JComboBox c1,c2,c3;//MOnth,Date,and year drop down
 
 Random ran = new Random();// for form Number
 long first4 = (ran.nextLong()%9000L) + 1000L;//may generate 4 digit long +ve -ve number
 long first = Math.abs(first4);//to make -ve to +ve
 ...
 Signup(){
	 ...
	 //if we use super text will be on left side 
